...
class MAPPO():
    ...
    def __init__(self,obs_dim,state_dim,critic_input,hidden_size, action_dim, lr,gamma,lamda,epsilon,device): 
        self.N=4
    ...
    def train(self,transition):
        ...
        _, a_logprob_n_now, dist_entropy = self.choose_train_action(s)#torch.Size([63, 4])            
        ...
        actor_loss = -torch.min(surr1, surr2) + 0.15 * dist_entropy        
